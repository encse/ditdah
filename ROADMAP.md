...
- [x] Let the application run owner-identified background work under the active page or modal lifecycle and wait for it during layer shutdown; background work explicitly marshals UI changes through `Update`.
